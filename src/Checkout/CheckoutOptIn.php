...
/**
 * Añade el checkbox de consentimiento WhatsApp en el checkout y guarda la preferencia en el pedido.
 */
final class CheckoutOptIn {

	/** Registra los hooks de WooCommerce para el opt-in de WhatsApp. */
	...
	/** Renderiza el checkbox de consentimiento antes del botón de confirmación del pedido. */
		...
		<div class="waxap-checkout-consent">
			<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
				...
				<span class="waxap-consent-label">
					...
					<?php esc_html_e( 'Quiero recibir actualizaciones de mi pedido por WhatsApp', 'waxap-for-woocommerce' ); ?>
				</span>
			</label>
		</div>
		<?php
	...
	/**
	 * Guarda la preferencia de opt-in de WhatsApp en los metadatos del pedido.
	 *
	 * @param WC_Order            $order Objeto del pedido recién creado.
	 * @param array<string,mixed> $data  Datos del formulario de checkout (requerido por el hook, no utilizado).
	 */
	public function save_opt_in( WC_Order $order, array $data ): void { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
